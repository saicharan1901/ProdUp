            ...
            <div className="container mx-auto py-8 max-w-7xl">
                <div className="bg-gray-800 rounded-lg shadow-lg px-8 py-6 mb-8 border-gray-600 border mx-auto hover:border-yellow-700 transition duration-300 transform hover:scale-105 hover:shadow-2xl">
                    <div className="mb-4">
                        <input
                            ...
                            id="title"
                            name="title"
                            className="w-full px-3 py-2 placeholder-gray-400 rounded-lg focus:outline-non bg-transparent text-white transition duration-300 transform focus:ring-2"
                            placeholder="Title..."
                            value={title}
                ...
                <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-6 mx-auto">
                    {notes.map((note) => (
                        <div
                            key={note.note_id}
                            className="bg-gray-900 rounded-lg shadow-lg p-6 mb-6 break-inside-avoid break-words hover:border-yellow-700 border transition-all duration-300 ease-in-out transform hover:scale-105"
                        >
                            ...
                            <button
                                className="absolute top-0 right-0 p-1 text-white hover:text-yellow-600 transition-all duration-300 ease-in-out opacity-100 group-hover:opacity-100"
